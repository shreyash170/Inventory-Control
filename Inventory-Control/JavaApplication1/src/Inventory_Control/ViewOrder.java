...
public void SelectOrder(){
    try{
        ...
        Rs = St.executeQuery("select * from ORDER_TABLE");
    ...
    private void initComponents() {
        ...
        OrderTable.setFont(new java.awt.Font("Calibri Light", 1, 18)); // NOI18N
        ...
        OrderTable.setSelectionBackground(new java.awt.Color(0, 153, 204));
